<nav class="flex flex-row  space-x-5 p-2 text-zinc-800 border-solid border-2 shadow-sm rounded-lg">
    <a class="inline-flex items-center text-lg tracking-tighter font-semibold"
        href={{ route('index') }}>Sistema de
