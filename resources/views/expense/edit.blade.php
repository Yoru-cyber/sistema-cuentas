        ...
        <form action="" method="POST" class="w-[90vw] sm:w-3/12 p-5 space-y-5 bg-slate-100  shadow-lg  text-zinc-800">
            ...
            <div class="form-group">
                <label class="input input-bordered flex items-center gap-2 bg-white" for="name">
                    ...
                    <input type="text" id="name" name="name" class="grow" placeholder="Nombre" value={{$expense->name}} required />
                </label>
                @error('name')
            ...
            <div class="form-group">
                <label class="input input-bordered flex items-center gap-2 bg-white" for="value">
                    ...
                    <input type="number" id="value" name="value" class="grow" value={{$expense->value}} inputmode="numeric"
            ...
            <div class="form-group">
                <label class="input input-bordered flex items-center gap-2 bg-white" for="profit_id">
                    ...
                    <input type="number" id="profit_id" name="profit_id" class="grow" value={{$expense->profit_id}} placeholder="Mes" required />
                </label>
                @error('profit_id')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group">
                ...
                <label class="input input-bordered flex items-center gap-2 bg-white" for="date">
                    ...
                    <input type="date" id="date" name="date" class="grow" value={{$expense->date}} required />
                </label>
                @error('date')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
